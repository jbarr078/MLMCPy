...
functionality. This is script #2 for running the user-defined model on each
level for the inputs prescribed by MLMCPy.
'''

# Step 2 - Generate model outputs for each level:

# Run the model on each level using the input data generated by
